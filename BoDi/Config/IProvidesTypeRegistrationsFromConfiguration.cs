...
{
  public interface IProvidesTypeRegistrationsFromConfiguration : IProvidesRegistrations
  {
    IReadOnlyList<IRegistration> GetRegistrations(ContainerRegistrationCollection registrations);
  }
}
